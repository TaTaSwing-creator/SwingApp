                ...
                Event::WindowEvent {
                    ...
                    let draw_data = {
                        ...
                        if runtime_controller.debug_overlay_shown {
                            let _window_bg = ui.push_style_color(StyleColor::WindowBg, [0.025, 0.025, 0.028, 0.98]);
                            ...
                            let _header = ui.push_style_color(StyleColor::Header, [0.55, 0.03, 0.03, 1.0]);
                            let _header_hovered = ui.push_style_color(StyleColor::HeaderHovered, [0.70, 0.05, 0.05, 1.0]);
                            let _header_active = ui.push_style_color(StyleColor::HeaderActive, [0.80, 0.06, 0.06, 1.0]);
                            let _frame_bg = ui.push_style_color(StyleColor::FrameBg, [0.10, 0.10, 0.12, 1.0]);
                            ...
                            ui.window("Render Debug")
                                ...
                                .size_constraints([520.0, 430.0], [520.0, 430.0])
