...
pub struct EspPlayerSettings {
    ...
    pub box_width: f32,
    pub box_shadow: bool,
    pub box_corners: bool,
    pub box_fill: bool,
    pub box_fill_color: EspColor,
    ...
    pub health_bar_color: EspColor,

    pub info_name: bool,
    pub info_name_color: EspColor,
    pub info_name_position: EspInfoPosition,

    pub info_distance: bool,
    pub info_distance_color: EspColor,
    pub info_distance_position: EspInfoPosition,
    ...
    pub info_weapon_position: EspInfoPosition,

    pub info_ammo: bool,
    pub info_ammo_color: EspColor,
    pub info_ammo_position: EspInfoPosition,

    pub info_hp_text: bool,
    pub info_hp_text_color: EspColor,
    pub info_hp_text_position: EspInfoPosition,
    ...
    pub info_flags_position: EspInfoPosition,

    pub info_grenades: bool,
    pub info_grenades_color: EspColor,
    pub info_grenades_position: EspInfoPosition,
...
impl EspPlayerSettings {
    pub fn new(target: &EspSelector) -> Self {
        ...
        Self {
            ...
            box_corners: false,
            box_fill: false,
            box_fill_color: EspColor::from_rgba(1.0, 0.0, 0.0, 0.20),
            ...
            health_bar_color: color.clone(),

            info_distance: false,
            info_distance_color: color.clone(),
            info_distance_position: EspInfoPosition::Right,
            ...
            info_hp_text_position: EspInfoPosition::Right,

            info_name: false,
            info_name_color: color.clone(),
            info_name_position: EspInfoPosition::Right,

            info_weapon: false,
            info_weapon_color: color.clone(),
            info_weapon_position: EspInfoPosition::Right,

            info_ammo: false,
            info_ammo_color: color.clone(),
            info_ammo_position: EspInfoPosition::Right,
            ...
            info_flags_position: EspInfoPosition::Right,

            info_grenades: false,
            info_grenades_color: color.clone(),
            info_grenades_position: EspInfoPosition::Right,
...
impl Default for EspPlayerSettings {
    fn default() -> Self {
        ...
        Self {
            ...
            health_bar: EspHealthBar::None,
            health_bar_width: 10.0,
            health_bar_color: neutral_color,
